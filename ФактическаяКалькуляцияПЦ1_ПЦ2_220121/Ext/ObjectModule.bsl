Функция ПолучитьТекстЗапроса() Экспорт
	...
	Возврат "ВЫБРАТЬ
	        ...
	        |			ГДЕ
	        |				СпособыРаспределенияЗатратНаВыпускФильтры.Ссылка.Наименование ПОДОБНО ""только годный выпуск_  По объему выпуска%"")
	        |;
	        |
	        |////////////////////////////////////////////////////////////////////////////////
	        |ВЫБРАТЬ
	        ...
	        |	ЗатратыНаВыпускПродукцииНаработкаБухгалтерскийУчетОстатки.Заказ,
	        |	ЗатратыНаВыпускПродукцииНаработкаБухгалтерскийУчетОстатки.ЗаказНЗП
	        ...
	        |	ЗатратыНаВыпускПродукцииНаработкаБухгалтерскийУчетОбороты.Заказ,
	        |	ЗатратыНаВыпускПродукцииНаработкаБухгалтерскийУчетОбороты.ЗаказНЗП
	        |ИЗ
	        ...
	        |	0,
	        |	0,
	        |	НЗПНаНачалоЗатраты.Заказ,
	        |	НЗПНаНачалоЗатраты.ЗаказНЗП
	        |ИЗ
	        ...
	        |	НЗПНаКонецЗатраты.Заказ,
	        |	НЗПНаКонецЗатраты.ЗаказНЗП
	        |ИЗ
	        ...
	        |ПОМЕСТИТЬ БазоваяВыборкаЗнВПБезВалков
	        |ИЗ
	        ...
	        |////////////////////////////////////////////////////////////////////////////////
	        |ВЫБРАТЬ
	        |	ЗаказНаПроизводствоБВ_ТрудочасыПоПериодам.Период,
	        |	СУММА(ЗаказНаПроизводствоБВ_ТрудочасыПоПериодам.Трудочасы) КАК Трудочасы,
	        |	ЗаказНаПроизводствоБВ_ТрудочасыПоПериодам.Ссылка.БВ_ПодразделениеЗаказчик,
	        |	ЗаказНаПроизводствоБВ_ТрудочасыПоПериодам.Ссылка.БВ_Продукция,
	        |	ЗаказНаПроизводствоБВ_ТрудочасыПоПериодам.Ссылка.Подразделение
	        |ПОМЕСТИТЬ ТрудочасыВсе
	        |ИЗ
	        |	Документ.ЗаказНаПроизводство.БВ_ТрудочасыПоПериодам КАК ЗаказНаПроизводствоБВ_ТрудочасыПоПериодам
	        |ГДЕ
	        |	НАЧАЛОПЕРИОДА(ЗаказНаПроизводствоБВ_ТрудочасыПоПериодам.Период, МЕСЯЦ) = &НачДата
	        |	И ЗаказНаПроизводствоБВ_ТрудочасыПоПериодам.Ссылка.БВ_ПодразделениеЗаказчик В ИЕРАРХИИ(&Подразделение)
	        |
	        |СГРУППИРОВАТЬ ПО
	        |	ЗаказНаПроизводствоБВ_ТрудочасыПоПериодам.Период,
	        |	ЗаказНаПроизводствоБВ_ТрудочасыПоПериодам.Ссылка.БВ_ПодразделениеЗаказчик,
	        ...
	        |	ТрудочасыВсе.БВ_Продукция,
	        |	ТрудочасыВсе.Подразделение КАК Подразделение1,
	        |	ТрудочасыВсе.БВ_ПодразделениеЗаказчик,
	        |	ТрудочасыВсе.Трудочасы
	        |ПОМЕСТИТЬ ТрудочасыВалки
	        |ИЗ
	        |	БазоваяВыборкаЗнВПБезВалков КАК БазоваяВыборкаЗнВП
	        |		ЛЕВОЕ СОЕДИНЕНИЕ ТрудочасыВсе КАК ТрудочасыВсе
	        |		ПО БазоваяВыборкаЗнВП.Подразделение = ТрудочасыВсе.БВ_ПодразделениеЗаказчик
	        |			И БазоваяВыборкаЗнВП.Затрата = ТрудочасыВсе.БВ_Продукция
	        |ГДЕ
	        |	НЕ ТрудочасыВсе.БВ_Продукция ЕСТЬ NULL
	        |;
	        |
	        |////////////////////////////////////////////////////////////////////////////////
	        |ВЫБРАТЬ
	        |	ТрудочасыВалки.Организация,
	        |	ТрудочасыВалки.БВ_ПодразделениеЗаказчик,
	        |	ТрудочасыВалки.БВ_Продукция,
	        |	СУММА(ТрудочасыВалки.КоличествоОборот) КАК КоличествоОборот
	        |ПОМЕСТИТЬ ТрудочасыВалкиИтого
	        |ИЗ
	        |	ТрудочасыВалки КАК ТрудочасыВалки
	        |
	        |СГРУППИРОВАТЬ ПО
	        |	ТрудочасыВалки.Организация,
	        |	ТрудочасыВалки.БВ_ПодразделениеЗаказчик,
	        ...
	        |ВЫБРАТЬ
	        |	ТрудочасыВалки.Организация,
	        |	ТрудочасыВалки.Подразделение,
	        |	ТрудочасыВалки.Продукция,
	        |	ТрудочасыВалки.СтатьяЗатрат,
	        |	ТрудочасыВалки.Затрата,
	        |	ТрудочасыВалки.СуммаОборот,
	        |	ТрудочасыВалки.НоменклатурнаяГруппаЗатрат,
	        |	ТрудочасыВалки.Нормируемая,
	        |	ТрудочасыВалки.ЗатратаЕдиницаХраненияОстатков,
	        |	ТрудочасыВалки.БВ_Продукция,
	        |	ТрудочасыВалки.БВ_ПодразделениеЗаказчик,
	        |	ТрудочасыВалки.Трудочасы,
	        |	ВЫБОР
	        |		КОГДА ТрудочасыВалкиИтого.КоличествоОборот = 0
	        |			ТОГДА 1
	        |		ИНАЧЕ ТрудочасыВалки.КоличествоОборот / ТрудочасыВалкиИтого.КоличествоОборот
	        |	КОНЕЦ КАК КоличествоТрудозатратКоэффициент,
	        |	ВЫБОР
	        |		КОГДА ТрудочасыВалкиИтого.КоличествоОборот = 0
	        |			ТОГДА 0
	        |		ИНАЧЕ ТрудочасыВалки.КоличествоОборот / ТрудочасыВалкиИтого.КоличествоОборот * ТрудочасыВалки.Трудочасы
	        |	КОНЕЦ КАК Количество
	        |ПОМЕСТИТЬ ТрудочасыВалкиРассчитаны
	        |ИЗ
	        |	ТрудочасыВалки КАК ТрудочасыВалки
	        |		ЛЕВОЕ СОЕДИНЕНИЕ ТрудочасыВалкиИтого КАК ТрудочасыВалкиИтого
	        |		ПО ТрудочасыВалки.Организация = ТрудочасыВалкиИтого.Организация
	        |			И ТрудочасыВалки.Подразделение = ТрудочасыВалкиИтого.БВ_ПодразделениеЗаказчик
	        |			И ТрудочасыВалки.Затрата = ТрудочасыВалкиИтого.БВ_Продукция
	        |;
	        |
	        |////////////////////////////////////////////////////////////////////////////////
	        |ВЫБРАТЬ
	        ...
	        |	ЗатратыНаВыпуск.СуммаОборот,
	        |	ЗатратыНаВыпуск.НоменклатурнаяГруппаЗатрат,
	        |	ЗатратыНаВыпуск.Нормируемая КАК Нормируемая,
	        |	ЗатратыНаВыпуск.ЗатратаЕдиницаХраненияОстатков
	        |ПОМЕСТИТЬ БазоваяВыборкаЗнВП
	        |ИЗ
	        |	БазоваяВыборкаЗнВПБезВалков КАК ЗатратыНаВыпуск
	        |ГДЕ
	        |	НЕ ЗатратыНаВыпуск.Затрата В
	        |				(ВЫБРАТЬ
	        |					ТрудочасыВалкиРассчитаны.Затрата
	        |				ИЗ
	        |					ТрудочасыВалкиРассчитаны КАК ТрудочасыВалкиРассчитаны)
	        |
	        |ОБЪЕДИНИТЬ ВСЕ
	        |
	        |ВЫБРАТЬ
	        |	ТрудочасыВалкиРассчитаны.Организация,
	        |	ТрудочасыВалкиРассчитаны.Подразделение,
	        |	ТрудочасыВалкиРассчитаны.Продукция,
	        |	ТрудочасыВалкиРассчитаны.СтатьяЗатрат,
	        |	ТрудочасыВалкиРассчитаны.Затрата,
	        |	ТрудочасыВалкиРассчитаны.Количество,
	        |	ТрудочасыВалкиРассчитаны.СуммаОборот,
	        |	ТрудочасыВалкиРассчитаны.НоменклатурнаяГруппаЗатрат,
	        |	ТрудочасыВалкиРассчитаны.Нормируемая,
	        |	ТрудочасыВалкиРассчитаны.ЗатратаЕдиницаХраненияОстатков
	        |ИЗ
	        |	ТрудочасыВалкиРассчитаны КАК ТрудочасыВалкиРассчитаны
	        |;
	        |
	        ...
	        |	ВыпускПродукцииБухгалтерскийУчет.Заказ,
	        |	ВыпускПродукцииБухгалтерскийУчет.ДокументВыпуска,
	        |	ВыпускПродукцииБухгалтерскийУчет.ПродукцияПолучатель
	        |;
	        |
	        |////////////////////////////////////////////////////////////////////////////////
	        |ВЫБРАТЬ
	        ...
	        |	И ОприходованиеМатериаловИзПроизводстваМатериалы.СтатьяЗатрат = &Отходы
	        ...
	        |		ВыпускПродукцииБухгалтерскийУчетОбороты.Продукция) КАК ВыпускПродукции
	        |;
	        |
	        |////////////////////////////////////////////////////////////////////////////////
	        |ВЫБРАТЬ
	        ...
	        |ПОМЕСТИТЬ ИтогоПоСтатьямЗатрат
	        |ИЗ
	        |	БазоваяВыборкаЗнВП КАК БазоваяВыборкаЗнВП
	        |
	        |СГРУППИРОВАТЬ ПО
	        ...
	        |	БазоваяВыборкаЗнВП.СтатьяЗатрат,
	        |	СУММА(БазоваяВыборкаЗнВП.СуммаОборот) КАК СуммаОборот
	        |ПОМЕСТИТЬ ИтогоПоПодразделениямПродукциямСтатьямЗатрат
	        |ИЗ
	        |	БазоваяВыборкаЗнВП КАК БазоваяВыборкаЗнВП
	        |
	        |СГРУППИРОВАТЬ ПО
	        ...
	        |////////////////////////////////////////////////////////////////////////////////
	        |ВЫБРАТЬ
	        |	ИтогоПоПодразделениямПродукциямСтатьямЗатрат.Организация,
	        |	ИтогоПоПодразделениямПродукциямСтатьямЗатрат.Подразделение,
	        |	ИтогоПоПодразделениямПродукциямСтатьямЗатрат.Продукция,
	        |	ИтогоПоПодразделениямПродукциямСтатьямЗатрат.СтатьяЗатрат,
	        |	ИтогоПоПодразделениямПродукциямСтатьямЗатрат.СуммаОборот,
	        |	ИтогоПоСтатьямЗатрат.СуммаОборот КАК СуммаИтого,
	        |	ИтогоПоПодразделениямПродукциямСтатьямЗатрат.СуммаОборот / ИтогоПоСтатьямЗатрат.СуммаОборот КАК К_ПоПодразделению
	        |ПОМЕСТИТЬ К1
	        |ИЗ
	        |	ИтогоПоПодразделениямПродукциямСтатьямЗатрат КАК ИтогоПоПодразделениямПродукциямСтатьямЗатрат
	        |		ВНУТРЕННЕЕ СОЕДИНЕНИЕ ИтогоПоСтатьямЗатрат КАК ИтогоПоСтатьямЗатрат
	        |		ПО ИтогоПоПодразделениямПродукциямСтатьямЗатрат.Организация = ИтогоПоСтатьямЗатрат.Организация
	        |			И ИтогоПоПодразделениямПродукциямСтатьямЗатрат.СтатьяЗатрат = ИтогоПоСтатьямЗатрат.СтатьяЗатрат
	        |			И ИтогоПоПодразделениямПродукциямСтатьямЗатрат.Подразделение = ИтогоПоСтатьямЗатрат.Подразделение
	        |;
	        |
	        |////////////////////////////////////////////////////////////////////////////////
	        |ВЫБРАТЬ
	        ...
	        |	ЗатратыИУслугиЦехов.СтатьяЗатрат,
	        |	ЗатратыИУслугиЦехов.Номенклатура,
	        |	ЗатратыИУслугиЦехов.Количество,
	        |	ЗатратыИУслугиЦехов.Стоимость,
	        |	ЗатратыИУслугиЦехов.Подгруппа,
	        |	ЗатратыИУслугиЦехов.Подразделение,
	        |	К1.К_ПоПодразделению,
	        |	ЗатратыИУслугиЦехов.Количество * К1.К_ПоПодразделению КАК КоличествоЗатраты,
	        |	ЗатратыИУслугиЦехов.Стоимость * К1.К_ПоПодразделению КАК СтоимостьЗатраты,
	        |	К1.Продукция,
	        |	ЗатратыИУслугиЦехов.Регистратор,
	        |	ЗатратыИУслугиЦехов.Нормируемая,
	        |	ЗатратыИУслугиЦехов.ПокупныеСобственные,
	        |	ЗатратыИУслугиЦехов.ЕдиницаИзмерения
	        |ПОМЕСТИТЬ Р_ПоПодразделениям
	        |ИЗ
	        |	ЗатратыИУслугиЦеховПравильные КАК ЗатратыИУслугиЦехов
	        |		ЛЕВОЕ СОЕДИНЕНИЕ К1 КАК К1
	        |		ПО ЗатратыИУслугиЦехов.Организация = К1.Организация
	        |			И ЗатратыИУслугиЦехов.СтатьяЗатрат = К1.СтатьяЗатрат
	        |			И ЗатратыИУслугиЦехов.Подразделение = К1.Подразделение
	        |;
	        |
	        |////////////////////////////////////////////////////////////////////////////////
	        |ВЫБРАТЬ
	        ...
	        |	К2.Продукция,
	        |	К2.СтатьяЗатрат,
	        |	СУММА(К2.СуммаОборот) КАК СуммаОборот
	        |ПОМЕСТИТЬ К2
	        |ИЗ
	        |	(ВЫБРАТЬ
	        |		К1.Организация КАК Организация,
	        |		К1.Подразделение КАК Подразделение,
	        |		К1.Продукция КАК Продукция,
	        |		К1.СтатьяЗатрат КАК СтатьяЗатрат,
	        |		К1.СуммаОборот КАК СуммаОборот
	        |	ИЗ
	        |		К1 КАК К1
	        |	ГДЕ
	        |		К1.Подразделение В
	        |				(ВЫБРАТЬ
	        |					Р_ПоПодразделениям.Подразделение
	        |				ИЗ
	        |					Р_ПоПодразделениям КАК Р_ПоПодразделениям)
	        |	
	        |	ОБЪЕДИНИТЬ ВСЕ
	        |	
	        |	ВЫБРАТЬ
	        |		Р_ПоПодразделениям.Организация,
	        |		Р_ПоПодразделениям.Подразделение,
	        |		Р_ПоПодразделениям.Продукция,
	        |		Р_ПоПодразделениям.СтатьяЗатрат,
	        |		-Р_ПоПодразделениям.СтоимостьЗатраты
	        |	ИЗ
	        |		Р_ПоПодразделениям КАК Р_ПоПодразделениям
	        |	ГДЕ
	        |		Р_ПоПодразделениям.Продукция ЕСТЬ НЕ NULL ) КАК К2
	        |
	        |СГРУППИРОВАТЬ ПО
	        |	К2.Организация,
	        |	К2.Подразделение,
	        ...
	        |	К2.СтатьяЗатрат,
	        |	К2.СуммаОборот,
	        |	К2Итого.СуммаОборот КАК СуммаИтого,
	        |	К2.СуммаОборот / К2Итого.СуммаОборот КАК К_Общий
	        |ПОМЕСТИТЬ К3
	        |ИЗ
	        |	К2 КАК К2
	        |		ВНУТРЕННЕЕ СОЕДИНЕНИЕ К2Итого КАК К2Итого
	        |		ПО К2.Организация = К2Итого.Организация
	        |			И К2.СтатьяЗатрат = К2Итого.СтатьяЗатрат
	        |ГДЕ
	        |	К2.СтатьяЗатрат В(&СтатьиЗатратСодержаниеОхранаТрудаПрочиеРемонтыТранспорт)
	        |;
	        |
	        |////////////////////////////////////////////////////////////////////////////////
	        |ВЫБРАТЬ
	        |	Проверка.Организация,
	        |	Проверка.СтатьяЗатрат,
	        |	Проверка.Стоимость,
	        |	ПодгонкаРасчетК.Разница,
	        |	ПодгонкаРасчетК.СуммаДано КАК ДолжноБытьРавноОсталосьРаспределитьПлюсУжеРаспределено,
	        |	К2Итого.СуммаОборот КАК ОсталосьРаспределеить,
	        |	Распределено.СтоимостьЗатраты КАК УжеРаспределено
	        |ПОМЕСТИТЬ Проверка
	        |ИЗ
	        |	(ВЫБРАТЬ
	        |		Р_ПоПодразделениям.Организация КАК Организация,
	        |		Р_ПоПодразделениям.СтатьяЗатрат КАК СтатьяЗатрат,
	        |		СУММА(Р_ПоПодразделениям.Стоимость) КАК Стоимость
	        |	ИЗ
	        |		Р_ПоПодразделениям КАК Р_ПоПодразделениям
	        |	ГДЕ
	        |		Р_ПоПодразделениям.Продукция ЕСТЬ NULL
	        |	
	        |	СГРУППИРОВАТЬ ПО
	        |		Р_ПоПодразделениям.Организация,
	        |		Р_ПоПодразделениям.СтатьяЗатрат) КАК Проверка
	        |		ЛЕВОЕ СОЕДИНЕНИЕ ПодгонкаРасчетК КАК ПодгонкаРасчетК
	        |		ПО Проверка.Организация = ПодгонкаРасчетК.Организация
	        |			И Проверка.СтатьяЗатрат = ПодгонкаРасчетК.СтатьяЗатрат
	        |		ЛЕВОЕ СОЕДИНЕНИЕ К2Итого КАК К2Итого
	        |		ПО Проверка.Организация = К2Итого.Организация
	        |			И Проверка.СтатьяЗатрат = К2Итого.СтатьяЗатрат
	        |		ЛЕВОЕ СОЕДИНЕНИЕ (ВЫБРАТЬ
	        |			Р_ПоПодразделениям.Организация КАК Организация,
	        |			Р_ПоПодразделениям.СтатьяЗатрат КАК СтатьяЗатрат,
	        |			СУММА(Р_ПоПодразделениям.СтоимостьЗатраты) КАК СтоимостьЗатраты
	        |		ИЗ
	        |			Р_ПоПодразделениям КАК Р_ПоПодразделениям
	        |		ГДЕ
	        |			Р_ПоПодразделениям.Продукция ЕСТЬ НЕ NULL 
	        |		
	        |		СГРУППИРОВАТЬ ПО
	        |			Р_ПоПодразделениям.Организация,
	        |			Р_ПоПодразделениям.СтатьяЗатрат) КАК Распределено
	        |		ПО Проверка.Организация = Распределено.Организация
	        |			И Проверка.СтатьяЗатрат = Распределено.СтатьяЗатрат
	        |;
	        |
	        |////////////////////////////////////////////////////////////////////////////////
	        |ВЫБРАТЬ
	        ...
	        |////////////////////////////////////////////////////////////////////////////////
	        |ВЫБРАТЬ
	        |	ПравильныйОстатокРаспределения.Организация,
	        |	ПравильныйОстатокРаспределения.СтатьяЗатрат,
	        |	ПравильныйОстатокРаспределения.Стоимость * К3.К_Общий КАК СтоимостьЗатраты,
	        |	ПравильныйОстатокРаспределения.Номенклатура,
	        |	ПравильныйОстатокРаспределения.Количество * К3.К_Общий КАК КоличествоЗатраты,
	        |	ПравильныйОстатокРаспределения.Подгруппа,
	        |	К3.К_Общий,
	        |	К3.Продукция,
	        |	ПодразделенияПоПродукции.Подразделение,
	        |	ПравильныйОстатокРаспределения.Регистратор,
	        |	ПравильныйОстатокРаспределения.Нормируемая,
	        |	ПравильныйОстатокРаспределения.ПокупныеСобственные,
	        |	ПравильныйОстатокРаспределения.ЕдиницаИзмерения
	        |ПОМЕСТИТЬ Р_Общая
	        |ИЗ
	        |	ПравильныйОстатокРаспределения КАК ПравильныйОстатокРаспределения
	        |		ЛЕВОЕ СОЕДИНЕНИЕ К3 КАК К3
	        |		ПО ПравильныйОстатокРаспределения.Организация = К3.Организация
	        |			И ПравильныйОстатокРаспределения.СтатьяЗатрат = К3.СтатьяЗатрат
	        |		ЛЕВОЕ СОЕДИНЕНИЕ (ВЫБРАТЬ
	        |			К1.Организация КАК Организация,
	        ...
	        |		СГРУППИРОВАТЬ ПО
	        |			К1.Организация,
	        |			К1.Продукция) КАК ПодразделенияПоПродукции
	        |		ПО (К3.Продукция = ПодразделенияПоПродукции.Продукция)
	        |;
	        |
	        |////////////////////////////////////////////////////////////////////////////////
	        |ВЫБРАТЬ
	        |	Р_ПоПодразделениям.Организация,
	        |	Р_ПоПодразделениям.СтатьяЗатрат,
	        |	Р_ПоПодразделениям.Номенклатура,
	        |	Р_ПоПодразделениям.Подгруппа,
	        |	Р_ПоПодразделениям.Подразделение,
	        |	Р_ПоПодразделениям.КоличествоЗатраты,
	        |	Р_ПоПодразделениям.СтоимостьЗатраты,
	        |	Р_ПоПодразделениям.Продукция,
	        |	Р_ПоПодразделениям.Регистратор,
	        |	Р_ПоПодразделениям.Нормируемая,
	        |	Р_ПоПодразделениям.ПокупныеСобственные,
	        |	Р_ПоПодразделениям.ЕдиницаИзмерения
	        |ПОМЕСТИТЬ РПП_РемонтыСодержаниеОхранаТранспортПрочие
	        |ИЗ
	        |	Р_ПоПодразделениям КАК Р_ПоПодразделениям
	        |ГДЕ
	        |	Р_ПоПодразделениям.Продукция ЕСТЬ НЕ NULL 
	        ...
	        |ВЫБРАТЬ
	        |	Р_Общая.Организация,
	        |	Р_Общая.СтатьяЗатрат,
	        |	Р_Общая.Номенклатура,
	        |	Р_Общая.Подгруппа,
	        |	Р_Общая.Подразделение,
	        |	Р_Общая.КоличествоЗатраты,
	        |	Р_Общая.СтоимостьЗатраты,
	        |	Р_Общая.Продукция,
	        |	Р_Общая.Регистратор,
	        |	Р_Общая.Нормируемая,
	        |	Р_Общая.ПокупныеСобственные,
	        |	Р_Общая.ЕдиницаИзмерения
	        |ИЗ
	        |	Р_Общая КАК Р_Общая
	        |;
	        |
	        ...
	        |	МАКСИМУМ(ВыпускПродукции.СтоимостьОборот) КАК СтоимостьОборот,
	        |	СУММА(ВыпускПродукции.СтоимостьЗаЕдиницу) КАК СтоимостьЗаЕдиницу
	        |ПОМЕСТИТЬ ИтогоВыпускБезНЗП
	        |ИЗ
	        ...
	        |	БракСтальногоЛитья.Продукция,
	        |	БракСтальногоЛитья.СтатьяЗатрат,
	        |	СУММА(БракСтальногоЛитья.КоличествоОборот) КАК КоличествоОборот,
	        |	СУММА(БракСтальногоЛитья.СуммаОборот) КАК СуммаОборот,
	        |	БракСтальногоЛитья.НоменклатурнаяГруппа
	        |ПОМЕСТИТЬ БракСтальногоЛитьяИтогоКоличество
	        |ИЗ
	        |	БракСтальногоЛитья КАК БракСтальногоЛитья
	        |ГДЕ
	        |	БракСтальногоЛитья.СтатьяЗатрат <> &Отходы
	        ...
	        |	БракСтальногоЛитья.НоменклатурнаяГруппа,
	        |	ВЫБОР
	        |		КОГДА БракСтальногоЛитьяИтогоКоличество.КоличествоОборот = 0
	        |			ТОГДА 0
	        |		ИНАЧЕ БракСтальногоЛитья.КоличествоОборот / БракСтальногоЛитьяИтогоКоличество.КоличествоОборот
	        |	КОНЕЦ КАК Коэффициент
	        |ПОМЕСТИТЬ БракКоэффициенты
	        |ИЗ
	        |	БракСтальногоЛитья КАК БракСтальногоЛитья
	        |		ВНУТРЕННЕЕ СОЕДИНЕНИЕ БракСтальногоЛитьяИтогоКоличество КАК БракСтальногоЛитьяИтогоКоличество
	        |		ПО БракСтальногоЛитья.Организация = БракСтальногоЛитьяИтогоКоличество.Организация
	        |			И БракСтальногоЛитья.Подразделение = БракСтальногоЛитьяИтогоКоличество.Подразделение
	        |			И БракСтальногоЛитья.СтатьяЗатрат = БракСтальногоЛитьяИтогоКоличество.СтатьяЗатрат
	        |			И БракСтальногоЛитья.НоменклатурнаяГруппа = БракСтальногоЛитьяИтогоКоличество.НоменклатурнаяГруппа
	        |			И БракСтальногоЛитья.Продукция = БракСтальногоЛитьяИтогоКоличество.Продукция
	        |;
	        |
	        |////////////////////////////////////////////////////////////////////////////////
	        |ВЫБРАТЬ
	        ...
	        |////////////////////////////////////////////////////////////////////////////////
	        |ВЫБРАТЬ
	        |	БракКоэффициенты.Организация,
	        |	ПодразделенияПоПродукции.Подразделение,
	        |	БракСтальногоЛитьяПоПродукциям.Продукция КАК Затрата,
	        |	&Отходы КАК СтатьяЗатрат,
	        |	БракКоэффициенты.Затрата КАК Продукция,
	        |	БракКоэффициенты.КоличествоОборот КАК КоличествоБрака,
	        |	БракКоэффициенты.СуммаОборот,
	        |	БракКоэффициенты.НоменклатурнаяГруппа,
	        |	БракКоэффициенты.Коэффициент,
	        |	БракСтальногоЛитьяПоПродукциям.КоличествоОборот КАК КоличествоОборот,
	        |	БракСтальногоЛитьяПоПродукциям.СуммаОборот * БракКоэффициенты.Коэффициент КАК СуммаБрака,
	        |	БракСтальногоЛитьяПоПродукциям.Продукция.НоменклатурнаяГруппа КАК НоменклатурнаяГруппаЗатрат,
	        |	ИСТИНА КАК Нормируемая,
	        |	""Собственные"" КАК ПокупныеСобственные,
	        |	БракСтальногоЛитьяПоПродукциям.Продукция.ЕдиницаХраненияОстатков КАК ЕдиницаИзмерения
	        |ПОМЕСТИТЬ Брак
	        |ИЗ
	        |	БракКоэффициенты КАК БракКоэффициенты
	        |		ВНУТРЕННЕЕ СОЕДИНЕНИЕ БракСтальногоЛитьяПоПродукциям КАК БракСтальногоЛитьяПоПродукциям
	        |		ПО БракКоэффициенты.Организация = БракСтальногоЛитьяПоПродукциям.Организация
	        |			И БракКоэффициенты.Подразделение = БракСтальногоЛитьяПоПродукциям.Подразделение
	        |			И БракКоэффициенты.НоменклатурнаяГруппа = БракСтальногоЛитьяПоПродукциям.НоменклатурнаяГруппа
	        |		ЛЕВОЕ СОЕДИНЕНИЕ (ВЫБРАТЬ
	        |			К1.Организация КАК Организация,
	        |			МАКСИМУМ(К1.Подразделение) КАК Подразделение
	        |		ИЗ
	        ...
	        |////////////////////////////////////////////////////////////////////////////////
	        |ВЫБРАТЬ
	        |	ЦенаПотериОтБракаОтносимый.Организация,
	        |	ЦенаПотериОтБракаОтносимый.Подразделение,
	        |	ЦенаПотериОтБракаОтносимый.СтатьяЗатрат,
	        |	ЦенаПотериОтБракаОтносимый.Продукция,
	        |	ЦенаПотериОтБракаОтносимый.КоличествоОборот,
	        |	ЦенаПотериОтБракаОтносимый.СуммаОборот,
	        |	ЦенаПотериОтБракаОтносимый.НоменклатурнаяГруппа,
	        |	ЦенаПотериОтБракаОтносимый.Затрата,
	        |	ЦенаПотериОтБракаОтносимый.НоменклатурнаяГруппаЗатрат,
	        |	ЦенаПотериОтБракаОтносимый.Подразделение1,
	        |	ЦенаПотериОтБракаОтносимый.Продукция1,
	        |	ВЫБОР
	        |		КОГДА ЦенаПотериОтБракаОтносимый.КоличествоОборот = 0
	        |			ТОГДА 0
	        |		ИНАЧЕ ЦенаПотериОтБракаОтносимый.СуммаОборот / ЦенаПотериОтБракаОтносимый.КоличествоОборот
	        |	КОНЕЦ КАК ЦенаБрака
	        |ПОМЕСТИТЬ ПотериОтБракаОтносимыйИтого
	        |ИЗ
	        |	(ВЫБРАТЬ
	        |		БракСтальногоЛитья.Организация КАК Организация,
	        |		ПодразделенияПоПродукции.Подразделение КАК Подразделение,
	        |		&СтатьяПотериОтБрака КАК СтатьяЗатрат,
	        |		&ЛомБрак КАК Продукция,
	        |		СУММА(ВЫБОР
	        ...
	        |		-СУММА(БракСтальногоЛитья.СуммаОборот) КАК СуммаОборот,
	        |		БракСтальногоЛитья.НоменклатурнаяГруппа КАК НоменклатурнаяГруппа,
	        ...
	        |		БракСтальногоЛитья.Подразделение,
	        |		БракСтальногоЛитья.Продукция) КАК ЦенаПотериОтБракаОтносимый
	        |;
	        |
	        |////////////////////////////////////////////////////////////////////////////////
	        |ВЫБРАТЬ
	        ...
	        |	ПодразделенияПоПродукции.Подразделение,
	        |	&СтатьяПотериОтБрака КАК СтатьяЗатрат,
	        |	БракСтальногоЛитья.Затрата КАК Продукция1,
	        |	БракСтальногоЛитья.КоличествоБрака КАК КоличествоОборот,
	        |	-СУММА(БракСтальногоЛитья.СуммаБрака) КАК СуммаБрака,
	        |	БракСтальногоЛитья.НоменклатурнаяГруппа,
	        |	""Относимого на другие цехи (-)"" КАК Затрата,
	        |	БракСтальногоЛитья.Продукция.НоменклатурнаяГруппа КАК НоменклатурнаяГруппаЗатрат,
	        |	ЦенаПотериОтБракаОтносимый.Подразделение1 КАК Подразделение1,
	        |	БракСтальногоЛитья.Продукция КАК Продукция,
	        |	ЦенаПотериОтБракаОтносимый.ЦенаБрака * БракСтальногоЛитья.КоличествоБрака КАК СуммаПроверка,
	        |	ЦенаПотериОтБракаОтносимый.КоличествоОборот КАК КоличествоОборотИтого,
	        |	ЦенаПотериОтБракаОтносимый.СуммаОборот КАК СуммаОборотИтого,
	        |	ВЫБОР
	        |		КОГДА ЦенаПотериОтБракаОтносимый.КоличествоОборот = 0
	        |			ТОГДА 0
	        |		ИНАЧЕ БракСтальногоЛитья.КоличествоБрака / ЦенаПотериОтБракаОтносимый.КоличествоОборот * ЦенаПотериОтБракаОтносимый.СуммаОборот
	        |	КОНЕЦ КАК СуммаОборот
	        |ПОМЕСТИТЬ ПотериОтБракаОтносимый
	        |ИЗ
	        |	Брак КАК БракСтальногоЛитья
	        |		ЛЕВОЕ СОЕДИНЕНИЕ (ВЫБРАТЬ
	        |			К1.Организация КАК Организация,
	        |			МАКСИМУМ(К1.Подразделение) КАК Подразделение
	        |		ИЗ
	        ...
	        |			К1.Организация) КАК ПодразделенияПоПродукции
	        |		ПО (ИСТИНА)
	        |		ЛЕВОЕ СОЕДИНЕНИЕ ПотериОтБракаОтносимыйИтого КАК ЦенаПотериОтБракаОтносимый
	        |		ПО (ИСТИНА)
	        |ГДЕ
	        |	БракСтальногоЛитья.НоменклатурнаяГруппа.Наименование ПОДОБНО ""Брак по металлу""
	        |
	        ...
	        |	ПодразделенияПоПродукции.Подразделение,
	        |	БракСтальногоЛитья.Затрата,
	        |	БракСтальногоЛитья.КоличествоБрака,
	        |	БракСтальногоЛитья.НоменклатурнаяГруппа,
	        |	БракСтальногоЛитья.Продукция.НоменклатурнаяГруппа,
	        |	ЦенаПотериОтБракаОтносимый.Подразделение1,
	        |	БракСтальногоЛитья.Продукция,
	        |	ЦенаПотериОтБракаОтносимый.ЦенаБрака * БракСтальногоЛитья.КоличествоБрака,
	        |	ЦенаПотериОтБракаОтносимый.КоличествоОборот,
	        |	ЦенаПотериОтБракаОтносимый.СуммаОборот
	        |;
	        |
	        ...
	        |ПОМЕСТИТЬ ПотериОтБракаВыявленныйИтого
	        |ИЗ
	        |	РегистрНакопления.ВыпускПродукцииБухгалтерскийУчет КАК ВыпускПродукцииБухгалтерскийУчет
	        |ГДЕ
	        |	ВыпускПродукцииБухгалтерскийУчет.Период МЕЖДУ &НачДата И &КонДата
	        ...
	        |	ЗатратыНаВыпускПродукцииНаработкаБухгалтерскийУчетОстатки.Заказ,
	        |	ЗатратыНаВыпускПродукцииНаработкаБухгалтерскийУчетОстатки.ЗаказНЗП
	        |ПОМЕСТИТЬ НЗПНаНачалоЗатратыПц2
	        |ИЗ
	        |	РегистрНакопления.ЗатратыНаВыпускПродукцииНаработкаБухгалтерскийУчет.Остатки(
	        |			&НачДата,
	        |			Организация = &Организация
	        |				И Подразделение В ИЕРАРХИИ (&ПодразделениеПЦ2)
	        |				И Продукция В
	        |					(ВЫБРАТЬ
	        |						СпособыРаспределения.Продукция
	        |					ИЗ
	        ...
	        |	ЗатратыНаВыпускПродукцииНаработкаБухгалтерскийУчетОстатки.Заказ,
	        |	ЗатратыНаВыпускПродукцииНаработкаБухгалтерскийУчетОстатки.ЗаказНЗП
	        |ПОМЕСТИТЬ НЗПНаКонецЗатратыПЦ2
	        |ИЗ
	        |	РегистрНакопления.ЗатратыНаВыпускПродукцииНаработкаБухгалтерскийУчет.Остатки(
	        |			ДОБАВИТЬКДАТЕ(&КонДата, СЕКУНДА, 1),
	        |			Организация = &Организация
	        ...
	        |	ЗатратыНаВыпускПродукцииБухгалтерскийУчетОбороты.Заказ,
	        |	ЗатратыНаВыпускПродукцииБухгалтерскийУчетОбороты.ЗаказНЗП
	        |ПОМЕСТИТЬ ЗатратыНаВыпускПлюсНаработкаПЦ2
	        |ИЗ
	        |	РегистрНакопления.ЗатратыНаВыпускПродукцииБухгалтерскийУчет.Обороты(
	        |			&НачДата,
	        |			&КонДата,
	        |			,
	        |			Организация = &Организация
	        |				И Подразделение В ИЕРАРХИИ (&ПодразделениеПЦ2)) КАК ЗатратыНаВыпускПродукцииБухгалтерскийУчетОбороты
	        |
	        |ОБЪЕДИНИТЬ ВСЕ
	        |
	        |ВЫБРАТЬ
	        ...
	        |		ЗНВППлюсНаработка.НоменклатурнаяГруппаЗатрат КАК НоменклатурнаяГруппаЗатрат
	        |	ИЗ
	        |		ЗатратыНаВыпускПлюсНаработкаПЦ2 КАК ЗНВППлюсНаработка
	        |	ГДЕ
	        |		ВЫБОР
	        |				КОГДА ЗНВППлюсНаработка.ВидВыпуска = ЗНАЧЕНИЕ(Перечисление.ВидыВыпуска.Наработка)
	        |					ТОГДА ИСТИНА
	        ...
	        |	ЗатратыНаВыпуск.СуммаОборот,
	        |	ЗатратыНаВыпуск.НоменклатурнаяГруппаЗатрат
	        |ПОМЕСТИТЬ СоответствиеПродукцииПЦ2иЗаготовкиПЦ1
	        |ИЗ
	        |	ЗатратыНаВыпускПЦ2 КАК ЗатратыНаВыпуск
	        |ГДЕ
	        |	ЗатратыНаВыпуск.СтатьяЗатрат.Наименование ПОДОБНО ""Полуфабрикаты""
	        |;
	        |
	        |////////////////////////////////////////////////////////////////////////////////
	        |ВЫБРАТЬ
	        |	ЗатратыНаВыпускПлюсНаработкаПЦ2.Организация,
	        |	ЗатратыНаВыпускПлюсНаработкаПЦ2.Подразделение,
	        |	ЗатратыНаВыпускПлюсНаработкаПЦ2.Продукция КАК ПродукцияБрак,
	        |	ЗатратыНаВыпускПлюсНаработкаПЦ2.СтатьяЗатрат,
	        |	ЗатратыНаВыпускПлюсНаработкаПЦ2.Затрата КАК ПродукцияПЦ2,
	        |	ЗатратыНаВыпускПлюсНаработкаПЦ2.КоличествоОборот,
	        |	ЗатратыНаВыпускПлюсНаработкаПЦ2.СуммаОборот,
	        |	ЗатратыНаВыпускПлюсНаработкаПЦ2.НоменклатурнаяГруппаЗатрат,
	        |	ЗатратыНаВыпускПлюсНаработкаПЦ2.ВидВыпуска,
	        |	ЗатратыНаВыпускПлюсНаработкаПЦ2.НоменклатурнаяГруппа,
	        |	ЗатратыНаВыпускПлюсНаработкаПЦ2.КоличествоНЗПНаНачало,
	        |	ЗатратыНаВыпускПлюсНаработкаПЦ2.СуммаНЗПНаНачало,
	        |	ЗатратыНаВыпускПлюсНаработкаПЦ2.КоличествоНЗПНаКонец,
	        |	ЗатратыНаВыпускПлюсНаработкаПЦ2.СуммаНЗПНаКонец,
	        |	ЗатратыНаВыпускПлюсНаработкаПЦ2.Заказ,
	        |	ЗатратыНаВыпускПлюсНаработкаПЦ2.ЗаказНЗП,
	        |	СоответствиеПродукцииПЦ2иЗаготовкиПЦ1.Затрата КАК Продукция
	        |ПОМЕСТИТЬ ПотериОтБракаВыявленныйПоПродукцииПЦ2
	        |ИЗ
	        |	ЗатратыНаВыпускПлюсНаработкаПЦ2 КАК ЗатратыНаВыпускПлюсНаработкаПЦ2
	        |		ЛЕВОЕ СОЕДИНЕНИЕ СоответствиеПродукцииПЦ2иЗаготовкиПЦ1 КАК СоответствиеПродукцииПЦ2иЗаготовкиПЦ1
	        |		ПО ЗатратыНаВыпускПлюсНаработкаПЦ2.Затрата = СоответствиеПродукцииПЦ2иЗаготовкиПЦ1.Продукция
	        |ГДЕ
	        |	ЗатратыНаВыпускПлюсНаработкаПЦ2.Продукция.Наименование ПОДОБНО ""Брак%""
	        |	И ЗатратыНаВыпускПлюсНаработкаПЦ2.НоменклатурнаяГруппа.Наименование ПОДОБНО ""Брак ПЦ-1""
	        |;
	        |
	        |////////////////////////////////////////////////////////////////////////////////
	        |ВЫБРАТЬ
	        |	ПотериОтБракаВыявленныйПоПродукцииПЦ2.Организация,
	        |	ПотериОтБракаВыявленныйПоПродукцииПЦ2.Продукция,
	        |	СУММА(ПотериОтБракаВыявленныйПоПродукцииПЦ2.КоличествоОборот) КАК Количество,
	        |	ПотериОтБракаВыявленныйИтого.ПодразделениеОтправитель,
	        |	ПотериОтБракаВыявленныйИтого.Продукция КАК Продукция1,
	        |	ПотериОтБракаВыявленныйИтого.Количество КАК Количество1,
	        |	ПотериОтБракаВыявленныйИтого.Стоимость КАК Стоимость1,
	        |	ПотериОтБракаВыявленныйИтого.Подразделение,
	        |	ПотериОтБракаВыявленныйИтого.СтатьяЗатрат,
	        |	ПотериОтБракаВыявленныйИтого.Затрата,
	        |	ПотериОтБракаВыявленныйИтого.НоменклатурнаяГруппаЗатрат,
	        |	ПотериОтБракаВыявленныйИтого.Подразделение1,
	        |	ВЫБОР
	        |		КОГДА ПотериОтБракаВыявленныйИтого.Количество = 0
	        |			ТОГДА 0
	        |		ИНАЧЕ СУММА(ПотериОтБракаВыявленныйПоПродукцииПЦ2.КоличествоОборот) / ПотериОтБракаВыявленныйИтого.Количество * ПотериОтБракаВыявленныйИтого.Стоимость
	        |	КОНЕЦ КАК Стоимость
	        |ПОМЕСТИТЬ ПотериОтБракаВыявленный
	        |ИЗ
	        |	ПотериОтБракаВыявленныйПоПродукцииПЦ2 КАК ПотериОтБракаВыявленныйПоПродукцииПЦ2,
	        |	ПотериОтБракаВыявленныйИтого КАК ПотериОтБракаВыявленныйИтого
	        |ГДЕ
	        |	НЕ ПотериОтБракаВыявленныйПоПродукцииПЦ2.Продукция ЕСТЬ NULL
	        |
	        |СГРУППИРОВАТЬ ПО
	        |	ПотериОтБракаВыявленныйПоПродукцииПЦ2.Организация,
	        |	ПотериОтБракаВыявленныйПоПродукцииПЦ2.Продукция,
	        |	ПотериОтБракаВыявленныйИтого.Организация,
	        |	ПотериОтБракаВыявленныйИтого.ПодразделениеОтправитель,
	        |	ПотериОтБракаВыявленныйИтого.Продукция,
	        |	ПотериОтБракаВыявленныйИтого.Количество,
	        |	ПотериОтБракаВыявленныйИтого.Стоимость,
	        |	ПотериОтБракаВыявленныйИтого.Подразделение,
	        |	ПотериОтБракаВыявленныйИтого.СтатьяЗатрат,
	        |	ПотериОтБракаВыявленныйИтого.Затрата,
	        |	ПотериОтБракаВыявленныйИтого.НоменклатурнаяГруппаЗатрат,
	        |	ПотериОтБракаВыявленныйИтого.Подразделение1,
	        |	ПотериОтБракаВыявленныйИтого.Продукция1
	        |;
	        |
	        |////////////////////////////////////////////////////////////////////////////////
	        |ВЫБРАТЬ
	        ...
	        |	ПотериОтБрака.Продукция1.ЕдиницаХраненияОстатков КАК ЕдиницаХраненияОстатков
	        ...
	        |	СУММА(БазоваяВыборкаЗнВПОтходы.КоличествоОборот) КАК КоличествоОборот,
	        |	СУММА(БазоваяВыборкаЗнВПОтходы.СуммаОборот) КАК СуммаОборот,
	        ...
	        |	БазоваяВыборкаЗнВПОтходы.Раздел,
	        |	БазоваяВыборкаЗнВПОтходы.Группа
	        |ПОМЕСТИТЬ БазоваяВыборкаЗнВПОтходы
	        |ИЗ
	        |	(ВЫБРАТЬ
	        |		БазоваяВыборкаЗнВП.Организация КАК Организация,
	        |		БазоваяВыборкаЗнВП.Подразделение КАК Подразделение,
	        |		БазоваяВыборкаЗнВП.Продукция КАК Продукция,
	        |		БазоваяВыборкаЗнВП.СтатьяЗатрат КАК СтатьяЗатрат,
	        |		БазоваяВыборкаЗнВП.Затрата КАК Затрата,
	        |		БазоваяВыборкаЗнВП.КоличествоОборот КАК КоличествоОборот,
	        |		БазоваяВыборкаЗнВП.СуммаОборот КАК СуммаОборот,
	        |		БазоваяВыборкаЗнВП.НоменклатурнаяГруппаЗатрат КАК НоменклатурнаяГруппаЗатрат,
	        |		NULL КАК Регистратор,
	        |		БазоваяВыборкаЗнВП.Нормируемая КАК Нормируемая,
	        |		ВЫБОР
	        |			КОГДА БазоваяВыборкаЗнВП.СтатьяЗатрат.Наименование ПОДОБНО ""БУ матераилы и запчасти""
	        |				ТОГДА ""Собственные""
	        |		КОНЕЦ КАК ПокупныеСобственные,
	        ...
	        |		РПП_РемонтыСодержаниеОхранаТранспортПрочие.Продукция,
	        |		РПП_РемонтыСодержаниеОхранаТранспортПрочие.СтатьяЗатрат,
	        |		РПП_РемонтыСодержаниеОхранаТранспортПрочие.Номенклатура,
	        |		РПП_РемонтыСодержаниеОхранаТранспортПрочие.КоличествоЗатраты,
	        |		РПП_РемонтыСодержаниеОхранаТранспортПрочие.СтоимостьЗатраты,
	        ...
	        |		NULL
	        |	ИЗ
	        |		РПП_РемонтыСодержаниеОхранаТранспортПрочие КАК РПП_РемонтыСодержаниеОхранаТранспортПрочие
	        |	
	        |	ОБЪЕДИНИТЬ ВСЕ
	        |	
	        |	ВЫБРАТЬ
	        ...
	        |		NULL
	        |	ИЗ
	        |		ЛомПотериОтБрака КАК ЛомПотериОтБрака) КАК БазоваяВыборкаЗнВПОтходы
	        |
	        |СГРУППИРОВАТЬ ПО
	        |	БазоваяВыборкаЗнВПОтходы.Организация,
	        |	БазоваяВыборкаЗнВПОтходы.Подразделение,
	        ...
	        |		КОГДА БазоваяВыборкаЗнВПОтходы.Затрата.Наименование ПОДОБНО ""%коксовая%""
	        ...
	        |			ТОГДА ВЫБОР
	        |					КОГДА БазоваяВыборкаЗнВПОтходыРазделы.СуммаОборот < 0
	        |							И БазоваяВыборкаЗнВПОтходыРазделы.НоменклатурнаяГруппаЗатрат <> ""Усреднение партий""
	        ...
	        |						ТОГДА ""Топливо""
	        |					КОГДА БазоваяВыборкаЗнВПОтходыРазделы.СтатьяЗатрат.Наименование ПОДОБНО ""Топливо%""
	        |						ТОГДА ""Топливо""
	        |					КОГДА БазоваяВыборкаЗнВПОтходыРазделы.Затрата.Наименование ПОДОБНО ""%коксовая%""
	        ...
	        |		НЗПНаКонец.Продукция КАК Продукция,
	        ...
	        |		ВыпускСУчетомНЗП.Продукция КАК Продукция,
	        ...
	        |			ТОГДА 0
	        |		ИНАЧЕ РППИтого.СуммаОборот / ИтогоВыпуск.КоличествоОборот
	        ...
	        |		КОГДА ВыпускПродукции.КоличествоОборот = 0
	        |			ТОГДА 0
	        |		ИНАЧЕ ВыпускПродукции.СтоимостьОборот / ВыпускПродукции.КоличествоОборот
	        |	КОНЕЦ КАК СтоимостьЗаЕдиницу,
	        ...
	        |					ТОГДА ВЫБОР
	        |							КОГДА БазоваяВыборкаЗнВПОтходыРазделыГруппы.Затрата.Наименование ПОДОБНО ""Слиток хромистой стали%""
	        |								ТОГДА ""Сталь Л""
	        ...
	        |	ВЫБОР
	        |		КОГДА Задано.КоличествоВыпуск = 0
	        |			ТОГДА 0
	        |		ИНАЧЕ РезультатБезПорядка.СуммаОборот / Задано.КоличествоВыпуск
	        |	КОНЕЦ КАК СтоимостьНаЕдиницу,
	        |	ВЫБОР
	        |		КОГДА Задано.КоличествоВыпуск = 0
	        |			ТОГДА 0
	        |		ИНАЧЕ РезультатБезПорядка.КоличествоОборот / Задано.КоличествоВыпуск
	        ...
	        |ГДЕ
	        |	ИтогоВыпуск.Продукция = &Продукция
	        |;
	        |
	        |////////////////////////////////////////////////////////////////////////////////
	        |ВЫБРАТЬ
	        ...
	        |ГДЕ
	        |	НЗПНаНачало.Продукция = &Продукция
	        |;
	        |
	        |////////////////////////////////////////////////////////////////////////////////
	        |ВЫБРАТЬ
	        ...
	        |ГДЕ
	        |	НЗПНаКонец.Продукция = &Продукция
	        |;
	        |
	        |////////////////////////////////////////////////////////////////////////////////
	        |ВЫБРАТЬ
...
Функция ПолучитьТекстЗапросаСвод() Экспорт
	...
	Возврат "ВЫБРАТЬ
	        ...
	        |////////////////////////////////////////////////////////////////////////////////
	        |ВЫБРАТЬ
	        |	ЗНВППлюсНаработка.Организация,
	        |	ЗНВППлюсНаработка.Подразделение,
	        |	ЗНВППлюсНаработка.Продукция,
	        |	ЗНВППлюсНаработка.СтатьяЗатрат,
	        |	ЗНВППлюсНаработка.Затрата,
	        |	СУММА(ЗНВППлюсНаработка.КоличествоОборот - ЗНВППлюсНаработка.КоличествоНЗПНаНачало + ЗНВППлюсНаработка.КоличествоНЗПНаКонец) КАК КоличествоОборот,
	        |	СУММА(ЗНВППлюсНаработка.СуммаОборот - ЗНВППлюсНаработка.СуммаНЗПНаНачало + ЗНВППлюсНаработка.СуммаНЗПНаКонец) КАК СуммаОборот,
	        |	ЗНВППлюсНаработка.НоменклатурнаяГруппаЗатрат
	        |ПОМЕСТИТЬ ЗатратыНаВыпуск
	        |ИЗ
	        |	ЗатратыНаВыпускПлюсНаработка КАК ЗНВППлюсНаработка
	        |ГДЕ
	        ...
	        |	ТрудочасыВалки.СтатьяЗатрат,
	        |	ТрудочасыВалки.Затрата,
	        |	ТрудочасыВалки.КоличествоОборот,
	        |	ТрудочасыВалки.СуммаОборот,
	        |	ТрудочасыВалки.НоменклатурнаяГруппаЗатрат,
	        |	ТрудочасыВалки.Нормируемая,
	        |	ТрудочасыВалки.ЗатратаЕдиницаХраненияОстатков,
	        ...
	        |	ТрудочасыВалки.БВ_ПодразделениеЗаказчик,
	        |	ТрудочасыВалки.Трудочасы,
	        |	ТрудочасыВалки.КоличествоОборот / ТрудочасыВалкиИтого.КоличествоОборот КАК КоличествоТрудозатратКоэффициент,
	        |	ТрудочасыВалки.КоличествоОборот / ТрудочасыВалкиИтого.КоличествоОборот * ТрудочасыВалки.Трудочасы КАК Количество
	        |ПОМЕСТИТЬ ТрудочасыВалкиРассчитаны
	        |ИЗ
	        |	ТрудочасыВалки КАК ТрудочасыВалки
	        |		ЛЕВОЕ СОЕДИНЕНИЕ ТрудочасыВалкиИтого КАК ТрудочасыВалкиИтого
	        ...
	        |	ВыпускПродукцииБухгалтерскийУчет.ПодразделениеПолучатель,
	        |	ВыпускПродукцииБухгалтерскийУчет.СтатьяЗатратПолучатель
	        |ПОМЕСТИТЬ УслугиЦеховБезТрудозатрат
	        |ИЗ
	        |	РегистрНакопления.ВыпускПродукцииБухгалтерскийУчет КАК ВыпускПродукцииБухгалтерскийУчет
	        |ГДЕ
	        |	ВыпускПродукцииБухгалтерскийУчет.Период МЕЖДУ &НачДата И &КонДата
	        ...
	        |////////////////////////////////////////////////////////////////////////////////
	        |ВЫБРАТЬ
	        |	УслугиЦехов.Организация,
	        |	УслугиЦехов.Подразделение,
	        |	УслугиЦехов.Продукция,
	        |	УслугиЦехов.Количество,
	        |	УслугиЦехов.Стоимость,
	        |	УслугиЦехов.КодОперации,
	        |	УслугиЦехов.ПодразделениеПолучатель,
	        |	УслугиЦехов.СтатьяЗатратПолучатель,
	        |	УслугиЦехов.ПодразделениеДляСоединения,
	        |	ТрудочасыВсе.Трудочасы,
	        |	ТрудочасыВсе.БВ_Продукция,
	        |	ТрудочасыВсе.Подразделение КАК ПодразделениеПоставщик
	        |ПОМЕСТИТЬ ТрудозатратыУслугиЦехов
	        |ИЗ
	        |	(ВЫБРАТЬ
	        |		УслугиЦехов.Организация КАК Организация,
	        |		УслугиЦехов.Подразделение КАК Подразделение,
	        |		УслугиЦехов.Продукция КАК Продукция,
	        |		УслугиЦехов.Количество КАК Количество,
	        |		УслугиЦехов.Стоимость КАК Стоимость,
	        |		УслугиЦехов.КодОперации КАК КодОперации,
	        |		УслугиЦехов.ПодразделениеПолучатель КАК ПодразделениеПолучатель,
	        |		УслугиЦехов.СтатьяЗатратПолучатель КАК СтатьяЗатратПолучатель,
	        |		СоответствиеПодразделенийИПодразделенийОрганизаций.Подразделение КАК ПодразделениеДляСоединения
	        |	ИЗ
	        |		УслугиЦеховБезТрудозатрат КАК УслугиЦехов
	        ...
	        |			ПО УслугиЦехов.Подразделение = СоответствиеПодразделенийИПодразделенийОрганизаций.ПодразделениеОрганизации) КАК УслугиЦехов
	        |		ЛЕВОЕ СОЕДИНЕНИЕ ТрудочасыВсе КАК ТрудочасыВсе
	        |		ПО УслугиЦехов.ПодразделениеДляСоединения = ТрудочасыВсе.Подразделение
	        |			И УслугиЦехов.Продукция = ТрудочасыВсе.БВ_Продукция
	        |			И УслугиЦехов.ПодразделениеПолучатель = ТрудочасыВсе.БВ_ПодразделениеЗаказчик
	        |ГДЕ
	        |	НЕ ТрудочасыВсе.БВ_Продукция ЕСТЬ NULL
	        |;
	        |
	        ...
	        |	ВыпускПродукцииБухгалтерскийУчет.Подразделение,
	        |	ВыпускПродукцииБухгалтерскийУчет.Продукция,
	        |	ВыпускПродукцииБухгалтерскийУчет.Количество КАК Количество,
	        |	ВыпускПродукцииБухгалтерскийУчет.Стоимость КАК Стоимость,
	        |	ВыпускПродукцииБухгалтерскийУчет.КодОперации,
	        |	ВыпускПродукцииБухгалтерскийУчет.ПодразделениеПолучатель,
	        |	ВыпускПродукцииБухгалтерскийУчет.СтатьяЗатратПолучатель
	        |ПОМЕСТИТЬ УслугиЦехов
	        |ИЗ
	        |	УслугиЦеховБезТрудозатрат КАК ВыпускПродукцииБухгалтерскийУчет
	        |ГДЕ
	        |	НЕ (ВыпускПродукцииБухгалтерскийУчет.Подразделение, ВыпускПродукцииБухгалтерскийУчет.Продукция) В
	        |				(ВЫБРАТЬ
	        |					ТрудозатратыУслугиЦехов.Подразделение,
	        |					ТрудозатратыУслугиЦехов.Продукция
	        |				ИЗ
	        |					ТрудозатратыУслугиЦехов КАК ТрудозатратыУслугиЦехов)
	        |
	        |ОБЪЕДИНИТЬ ВСЕ
	        |
	        |ВЫБРАТЬ
	        |	ТрудозатратыУслугиЦехов.Организация,
	        |	ТрудозатратыУслугиЦехов.Подразделение,
	        |	ТрудозатратыУслугиЦехов.Продукция,
	        |	ТрудозатратыУслугиЦехов.Трудочасы,
	        |	ТрудозатратыУслугиЦехов.Стоимость,
	        |	ТрудозатратыУслугиЦехов.КодОперации,
	        |	ТрудозатратыУслугиЦехов.ПодразделениеПолучатель,
	        |	ТрудозатратыУслугиЦехов.СтатьяЗатратПолучатель
	        |ИЗ
	        |	ТрудозатратыУслугиЦехов КАК ТрудозатратыУслугиЦехов
	        |;
	        |
	        ...
	        |	СУММА(ОприходованиеМатериаловИзПроизводстваМатериалы.Сумма) КАК Сумма,
	        |	ОприходованиеМатериаловИзПроизводстваМатериалы.Ссылка КАК Регистратор,
	        |	ОприходованиеМатериаловИзПроизводстваМатериалы.СтатьяЗатрат КАК СтатьяЗатрат1
	        |ПОМЕСТИТЬ ОтходыПрочие
	        |ИЗ
	        |	Документ.ОприходованиеМатериаловИзПроизводства.Материалы КАК ОприходованиеМатериаловИзПроизводстваМатериалы
	        |ГДЕ
	        ...
	        |	ОприходованиеМатериаловИзПроизводстваМатериалы.ЕдиницаИзмерения,
	        |	ОприходованиеМатериаловИзПроизводстваМатериалы.Ссылка,
	        |	ОприходованиеМатериаловИзПроизводстваМатериалы.СтатьяЗатрат
	        |;
	        |
	        |////////////////////////////////////////////////////////////////////////////////
	        |ВЫБРАТЬ
	        ...
	        |		ПО (ИСТИНА)
	        |ГДЕ
	        |	НЕ БракСтальногоЛитья.НоменклатурнаяГруппа.Наименование ПОДОБНО ""Брак ПЦ-2%""
	        |
	        |СГРУППИРОВАТЬ ПО
	        |	БракСтальногоЛитья.Организация,
	        |	ПодразделенияПоПродукции.Подразделение,
	        ...
	        |			ТОГДА ""Расходы по переделу""
	        |		КОГДА БазоваяВыборкаЗнВПОтходы.СтатьяЗатрат.Наименование ПОДОБНО ""%Сырье и основные материалы%""
	        |				И БазоваяВыборкаЗнВПОтходы.Затрата.Наименование ПОДОБНО ""Кислород%""
	        |			ТОГДА ""Расходы по переделу""
	        |		КОГДА БазоваяВыборкаЗнВПОтходы.СтатьяЗатрат.Наименование ПОДОБНО ""%Сырье и основные материалы%""
	        |				И БазоваяВыборкаЗнВПОтходы.Затрата.Наименование ПОДОБНО ""Азот%""
	        |			ТОГДА ""Расходы по переделу""
	        |		КОГДА БазоваяВыборкаЗнВПОтходы.СтатьяЗатрат.Наименование ПОДОБНО ""%Сырье и основные материалы%""
	        |			ТОГДА ""Сырье и основные материалы""
	        |		КОГДА БазоваяВыборкаЗнВПОтходы.СтатьяЗатрат.Наименование ПОДОБНО ""%Топливо технологическое%""
	        ...
	        |									ТОГДА ""Зарплата с начислениями""
	        |								ИНАЧЕ ВЫБОР
	        |										КОГДА БазоваяВыборкаЗнВПОтходыРазделыГруппы.Затрата.Наименование ПОДОБНО ""Кислород%""
	        |											ТОГДА ""Энергозатраты""
	        |										КОГДА БазоваяВыборкаЗнВПОтходыРазделыГруппы.Затрата.Наименование ПОДОБНО ""Азот%""
	        |											ТОГДА ""Энергозатраты""
	        |										КОГДА ВЫРАЗИТЬ(БазоваяВыборкаЗнВПОтходыРазделыГруппы.Затрата КАК Справочник.Номенклатура).Наименование ПОДОБНО ""Транспортировка газа%""
	        |											ТОГДА ""Энергозатраты""
	        |										КОГДА ВЫРАЗИТЬ(БазоваяВыборкаЗнВПОтходыРазделыГруппы.Затрата КАК Справочник.Номенклатура).ВидНоменклатуры.Наименование ПОДОБНО ""Огнеупор%""
	        ...
	        |				И НЕ(БазоваяВыборкаЗнВПОтходыРазделыГруппы.НоменклатурнаяГруппаЗатрат = ""Подрядчики""
	        |						ИЛИ БазоваяВыборкаЗнВПОтходыРазделыГруппы.НоменклатурнаяГруппаЗатрат = ""Прочее""
	        |						ИЛИ БазоваяВыборкаЗнВПОтходыРазделыГруппы.ПодГруппа ПОДОБНО ""Энергозатраты%"")
	        |			ТОГДА БазоваяВыборкаЗнВПОтходыРазделыГруппы.ПокупныеСобственные
	        |		ИНАЧЕ БазоваяВыборкаЗнВПОтходыРазделыГруппы.Затрата
	        |	КОНЕЦ КАК Затрата,
	        |	ВЫБОР
	        ...
	        |		КОГДА ИтогоВыпуск.КоличествоОборот = 0
	        |			ТОГДА 0
	        |		ИНАЧЕ ИтогоВыпуск.СтоимостьСНЗП / ИтогоВыпуск.КоличествоОборот
	        |	КОНЕЦ КАК СтоимостьНаЕдиницу,
	        |	""Производственная себестоимость с НЗП"" КАК Раздел
	        |ИЗ
	        |	ИтогоВыпуск КАК ИтогоВыпуск
...
Функция ПолучитьТекстЗапросаПоМаркам() Экспорт
	...
	Возврат "ВЫБРАТЬ
	        ...
	        |	ЗатратыНаВыпускПродукцииНаработкаБухгалтерскийУчетОстатки.Заказ,
	        |	ЗатратыНаВыпускПродукцииНаработкаБухгалтерскийУчетОстатки.ЗаказНЗП,
	        |	ЗатратыНаВыпускПродукцииНаработкаБухгалтерскийУчетОстатки.ХарактеристикаПродукции,
	        |	ЗатратыНаВыпускПродукцииНаработкаБухгалтерскийУчетОстатки.ХарактеристикаЗатраты
	        |ПОМЕСТИТЬ НЗПНаНачалоЗатраты
	        |ИЗ
	        |	РегистрНакопления.ЗатратыНаВыпускПродукцииНаработкаБухгалтерскийУчет.Остатки(
	        |			&НачДата,
	        ...
	        |	ЗатратыНаВыпускПродукцииНаработкаБухгалтерскийУчетОбороты.Заказ,
	        |	ЗатратыНаВыпускПродукцииНаработкаБухгалтерскийУчетОбороты.ЗаказНЗП,
	        |	ЗатратыНаВыпускПродукцииНаработкаБухгалтерскийУчетОбороты.ХарактеристикаПродукции,
	        |	ЗатратыНаВыпускПродукцииНаработкаБухгалтерскийУчетОбороты.ХарактеристикаЗатраты
	        |ИЗ
	        |	РегистрНакопления.ЗатратыНаВыпускПродукцииНаработкаБухгалтерскийУчет.Обороты(
	        |			НАЧАЛОПЕРИОДА(ДОБАВИТЬКДАТЕ(&НачДата, МЕСЯЦ, -1), МЕСЯЦ),
	        |			КОНЕЦПЕРИОДА(ДОБАВИТЬКДАТЕ(&КонДата, МЕСЯЦ, -1), МЕСЯЦ),
	        ...
	        |	НЗПНаНачалоЗатраты.Заказ,
	        |	НЗПНаНачалоЗатраты.ЗаказНЗП,
	        |	НЗПНаНачалоЗатраты.ХарактеристикаПродукции,
	        |	NULL
	        |ИЗ
	        |	НЗПНаНачалоЗатраты КАК НЗПНаНачалоЗатраты
	        |
	        ...
	        |	НЗПНаКонецЗатраты.Заказ,
	        |	НЗПНаКонецЗатраты.ЗаказНЗП,
	        |	НЗПНаКонецЗатраты.ХарактеристикаПродукции,
	        |	NULL
	        |ИЗ
	        |	НЗПНаКонецЗатраты КАК НЗПНаКонецЗатраты
	        |;
	        ...
	        |ПОМЕСТИТЬ МаркиСтали
	        |ИЗ
	        |	РегистрСведений.ЗначенияСвойствОбъектов КАК ЗначенияСвойствОбъектов
	        |ГДЕ
	        |	ЗначенияСвойствОбъектов.Объект В
	        |			(ВЫБРАТЬ
	        |				ЗатратыНаВыпускПлюсНаработка.ХарактеристикаПродукции
	        |			ИЗ
	        |				ЗатратыНаВыпускПлюсНаработка КАК ЗатратыНаВыпускПлюсНаработка)
	        |	И ЗначенияСвойствОбъектов.Свойство.Наименование ПОДОБНО ""Марка стали%""
	        |;
	        |
	        |////////////////////////////////////////////////////////////////////////////////
	        |ВЫБРАТЬ
	        |	ЗатратыНаВыпускПлюсНаработка.Организация,
	        |	ЗатратыНаВыпускПлюсНаработка.Подразделение,
	        |	ЗатратыНаВыпускПлюсНаработка.Продукция,
	        |	ЗатратыНаВыпускПлюсНаработка.СтатьяЗатрат,
	        |	ЗатратыНаВыпускПлюсНаработка.Затрата,
	        |	СУММА(ЗатратыНаВыпускПлюсНаработка.КоличествоОборот) КАК КоличествоОборот,
	        |	СУММА(ЗатратыНаВыпускПлюсНаработка.СуммаОборот) КАК СуммаОборот,
	        |	ЗатратыНаВыпускПлюсНаработка.НоменклатурнаяГруппаЗатрат,
	        |	ЗатратыНаВыпускПлюсНаработка.ВидВыпуска,
	        |	ЗатратыНаВыпускПлюсНаработка.НоменклатурнаяГруппа,
	        |	СУММА(ЗатратыНаВыпускПлюсНаработка.КоличествоНЗПНаНачало) КАК КоличествоНЗПНаНачало,
	        |	СУММА(ЗатратыНаВыпускПлюсНаработка.СуммаНЗПНаНачало) КАК СуммаНЗПНаНачало,
	        |	СУММА(ЗатратыНаВыпускПлюсНаработка.КоличествоНЗПНаКонец) КАК КоличествоНЗПНаКонец,
	        |	СУММА(ЗатратыНаВыпускПлюсНаработка.СуммаНЗПНаКонец) КАК СуммаНЗПНаКонец,
	        |	ЗатратыНаВыпускПлюсНаработка.Заказ,
	        |	ЗатратыНаВыпускПлюсНаработка.ЗаказНЗП,
	        |	МаркиСтали.Значение КАК МаркаСтали
	        |ПОМЕСТИТЬ ЗатратыНаВыпускПлюсНаработкаПоМаркам
	        |ИЗ
	        |	ЗатратыНаВыпускПлюсНаработка КАК ЗатратыНаВыпускПлюсНаработка
	        |		ЛЕВОЕ СОЕДИНЕНИЕ МаркиСтали КАК МаркиСтали
	        |		ПО ЗатратыНаВыпускПлюсНаработка.ХарактеристикаПродукции = МаркиСтали.Объект
	        |
	        |СГРУППИРОВАТЬ ПО
	        |	ЗатратыНаВыпускПлюсНаработка.Организация,
	        |	ЗатратыНаВыпускПлюсНаработка.Подразделение,
	        ...
	        |		ЗНВППлюсНаработка.СуммаОборот - ЗНВППлюсНаработка.СуммаНЗПНаНачало + ЗНВППлюсНаработка.СуммаНЗПНаКонец КАК СуммаОборот,
	        |		ЗНВППлюсНаработка.НоменклатурнаяГруппаЗатрат КАК НоменклатурнаяГруппаЗатрат,
	        |		ЗНВППлюсНаработка.МаркаСтали КАК МаркаСтали
	        |	ИЗ
	        |		ЗатратыНаВыпускПлюсНаработкаПоМаркам КАК ЗНВППлюсНаработка
	        |	ГДЕ
	        |		ВЫБОР
	        |				КОГДА ЗНВППлюсНаработка.ВидВыпуска = ЗНАЧЕНИЕ(Перечисление.ВидыВыпуска.Наработка)
	        |					ТОГДА ИСТИНА
	        ...
	        |	ТрудочасыВалкиРассчитаны.Нормируемая,
	        |	ТрудочасыВалкиРассчитаны.ЗатратаЕдиницаХраненияОстатков,
	        |	ТрудочасыВалкиРассчитаны.МаркаСтали
	        |ИЗ
	        |	ТрудочасыВалкиРассчитаны КАК ТрудочасыВалкиРассчитаны
	        |;
	        |
	        ...
	        |							СпособыРаспределения КАК СпособыРаспределения)) КАК ВыпускПродукцииБухгалтерскийУчетОбороты
	        |			ЛЕВОЕ СОЕДИНЕНИЕ МаркиСтали КАК МаркиСтали
	        |			ПО ВыпускПродукцииБухгалтерскийУчетОбороты.ХарактеристикаПродукции = МаркиСтали.Объект
	        |	ГДЕ
	        |		ВЫБОР
	        |				КОГДА ВыпускПродукцииБухгалтерскийУчетОбороты.НоменклатурнаяГруппа.Наименование ПОДОБНО ""Металлопродукция""
	        |					ТОГДА ИСТИНА
	        ...
	        |		МаркиСтали.Значение) КАК ВыпускПродукции
	        |;
	        |
	        |////////////////////////////////////////////////////////////////////////////////
	        |ВЫБРАТЬ
	        ...
	        |						СпособыРаспределения КАК СпособыРаспределения)) КАК ВыпускПродукцииНаработкаБухгалтерскийУчетОстатки
	        |		ЛЕВОЕ СОЕДИНЕНИЕ МаркиСтали КАК МаркиСтали
	        |		ПО ВыпускПродукцииНаработкаБухгалтерскийУчетОстатки.ХарактеристикаПродукции = МаркиСтали.Объект
	        |
	        |ОБЪЕДИНИТЬ ВСЕ
	        |
	        |ВЫБРАТЬ
	        ...
	        |	ИтогоПоПодразделениямПродукциямСтатьямЗатрат.Подразделение,
	        |	ИтогоПоПодразделениямПродукциямСтатьямЗатрат.Продукция,
	        |	ИтогоПоПодразделениямПродукциямСтатьямЗатрат.МаркаСтали,
	        |	ИтогоПоПодразделениямПродукциямСтатьямЗатрат.СтатьяЗатрат,
	        |	ИтогоПоПодразделениямПродукциямСтатьямЗатрат.СуммаОборот,
	        |	ИтогоПоСтатьямЗатрат.СуммаОборот КАК СуммаИтого,
	        |	ИтогоПоПодразделениямПродукциямСтатьямЗатрат.СуммаОборот / ИтогоПоСтатьямЗатрат.СуммаОборот КАК К_ПоПодразделению
	        ...
	        |	МаркиСтали.Значение КАК МаркаСтали,
	        |	ЗатратыНаВыпускПлюсНаработка.СтатьяЗатрат,
	        |	ЗатратыНаВыпускПлюсНаработка.Затрата КАК Затрата,
	        |	СУММА(ЗатратыНаВыпускПлюсНаработка.КоличествоОборот) КАК КоличествоОборот,
	        |	СУММА(ЗатратыНаВыпускПлюсНаработка.СуммаОборот) КАК СуммаОборот,
	        |	ЗатратыНаВыпускПлюсНаработка.НоменклатурнаяГруппа
	        |ПОМЕСТИТЬ БракСтальногоЛитья
	        ...
	        |	ЗатратыНаВыпускПлюсНаработка КАК ЗатратыНаВыпускПлюсНаработка
	        |		ЛЕВОЕ СОЕДИНЕНИЕ МаркиСтали КАК МаркиСтали
	        |		ПО ЗатратыНаВыпускПлюсНаработка.ХарактеристикаЗатраты = МаркиСтали.Объект
	        |ГДЕ
	        |	ЗатратыНаВыпускПлюсНаработка.Продукция.Наименование ПОДОБНО ""Брак%""
	        |
	        |СГРУППИРОВАТЬ ПО
	        |	ЗатратыНаВыпускПлюсНаработка.Организация,
	        |	ЗатратыНаВыпускПлюсНаработка.Подразделение,
	        ...
	        |	БракСтальногоЛитья.СтатьяЗатрат,
	        |	БракСтальногоЛитья.Затрата,
	        |	БракСтальногоЛитья.МаркаСтали,
	        |	БракСтальногоЛитья.КоличествоОборот,
	        |	БракСтальногоЛитья.СуммаОборот,
	        |	БракСтальногоЛитья.НоменклатурнаяГруппа,
	        |	БракСтальногоЛитья.КоличествоОборот / БракСтальногоЛитьяИтогоКоличество.КоличествоОборот КАК Коэффициент
	        |ПОМЕСТИТЬ БракКоэффициенты
	        |ИЗ
	        |	БракСтальногоЛитья КАК БракСтальногоЛитья
	        |		ВНУТРЕННЕЕ СОЕДИНЕНИЕ БракСтальногоЛитьяИтогоКоличество КАК БракСтальногоЛитьяИтогоКоличество
	        ...
	        |	ЦенаПотериОтБракаОтносимый.Подразделение1,
	        |	ЦенаПотериОтБракаОтносимый.Продукция1,
	        |	ЦенаПотериОтБракаОтносимый.СуммаОборот / ЦенаПотериОтБракаОтносимый.КоличествоОборот КАК ЦенаБрака
	        |ПОМЕСТИТЬ ПотериОтБракаОтносимыйИтого
	        |ИЗ
	        |	(ВЫБРАТЬ
	        |		БракСтальногоЛитья.Организация КАК Организация,
	        ...
	        |	ЦенаПотериОтБракаОтносимый.КоличествоОборот КАК КоличествоОборотИтого,
	        |	ЦенаПотериОтБракаОтносимый.СуммаОборот КАК СуммаОборотИтого,
	        |	БракСтальногоЛитья.КоличествоБрака / ЦенаПотериОтБракаОтносимый.КоличествоОборот * ЦенаПотериОтБракаОтносимый.СуммаОборот КАК СуммаОборот,
	        |	БракСтальногоЛитья.МаркаСтали
	        |ПОМЕСТИТЬ ПотериОтБракаОтносимый
	        |ИЗ
	        |	Брак КАК БракСтальногоЛитья
	        ...
	        |		ЗНВППлюсНаработка.СтатьяЗатрат КАК СтатьяЗатрат,
	        |		ЗНВППлюсНаработка.Затрата КАК Затрата,
	        |		ЗНВППлюсНаработка.КоличествоОборот КАК КоличествоОборот,
	        |		ЗНВППлюсНаработка.СуммаОборот КАК СуммаОборот,
	        |		ЗНВППлюсНаработка.НоменклатурнаяГруппаЗатрат КАК НоменклатурнаяГруппаЗатрат
	        |	ИЗ
	        |		ЗатратыНаВыпускПлюсНаработкаПЦ2 КАК ЗНВППлюсНаработка
	        |	ГДЕ
	        ...
	        |	ЗначенияСвойствОбъектов.Свойство,
	        |	ЗначенияСвойствОбъектов.Значение
	        |ПОМЕСТИТЬ МаркиСталиПЦ2
	        |ИЗ
	        |	РегистрСведений.ЗначенияСвойствОбъектов КАК ЗначенияСвойствОбъектов
	        |ГДЕ
	        |	ЗначенияСвойствОбъектов.Объект В
	        |			(ВЫБРАТЬ
	        |				ЗатратыНаВыпускПлюсНаработкаПЦ2.ХарактеристикаЗатраты
	        |			ИЗ
	        |				ЗатратыНаВыпускПлюсНаработкаПЦ2 КАК ЗатратыНаВыпускПлюсНаработкаПЦ2)
	        |	И ЗначенияСвойствОбъектов.Свойство.Наименование ПОДОБНО ""Марка стали%""
	        |;
	        ...
	        |	ЗатратыНаВыпускПлюсНаработкаПЦ2.ЗаказНЗП,
	        |	СоответствиеПродукцииПЦ2иЗаготовкиПЦ1.Затрата КАК Продукция,
	        |	МаркиСталиПЦ2.Значение КАК МаркаСтали
	        |ПОМЕСТИТЬ ПотериОтБракаВыявленныйПоПродукцииПЦ2
	        |ИЗ
	        |	ЗатратыНаВыпускПлюсНаработкаПЦ2 КАК ЗатратыНаВыпускПлюсНаработкаПЦ2
	        |		ЛЕВОЕ СОЕДИНЕНИЕ СоответствиеПродукцииПЦ2иЗаготовкиПЦ1 КАК СоответствиеПродукцииПЦ2иЗаготовкиПЦ1
	        |		ПО ЗатратыНаВыпускПлюсНаработкаПЦ2.Затрата = СоответствиеПродукцииПЦ2иЗаготовкиПЦ1.Продукция
	        |		ЛЕВОЕ СОЕДИНЕНИЕ МаркиСталиПЦ2 КАК МаркиСталиПЦ2
	        |		ПО ЗатратыНаВыпускПлюсНаработкаПЦ2.ХарактеристикаЗатраты = МаркиСталиПЦ2.Объект
	        |ГДЕ
	        |	ЗатратыНаВыпускПлюсНаработкаПЦ2.Продукция.Наименование ПОДОБНО ""Брак%""
	        |	И ЗатратыНаВыпускПлюсНаработкаПЦ2.НоменклатурнаяГруппа.Наименование ПОДОБНО ""Брак ПЦ-1""
	        |;
	        ...
	        |	ПотериОтБракаВыявленныйИтого.НоменклатурнаяГруппаЗатрат,
	        |	ПотериОтБракаВыявленныйИтого.Подразделение1,
	        |	СУММА(ПотериОтБракаВыявленныйПоПродукцииПЦ2.КоличествоОборот) / ПотериОтБракаВыявленныйИтого.Количество * ПотериОтБракаВыявленныйИтого.Стоимость КАК Стоимость,
	        |	ПотериОтБракаВыявленныйПоПродукцииПЦ2.МаркаСтали
	        |ПОМЕСТИТЬ ПотериОтБракаВыявленный
	        |ИЗ
	        |	ПотериОтБракаВыявленныйПоПродукцииПЦ2 КАК ПотериОтБракаВыявленныйПоПродукцииПЦ2,
	        |	ПотериОтБракаВыявленныйИтого КАК ПотериОтБракаВыявленныйИтого
	        ...
	        |	ПотериОтБракаОтносимый.Продукция1,
	        |	ПотериОтБракаОтносимый.Подразделение1,
	        |	ПотериОтБракаОтносимый.МаркаСтали
	        |ПОМЕСТИТЬ ПотериОтБрака
	        |ИЗ
	        |	ПотериОтБракаОтносимый КАК ПотериОтБракаОтносимый
	        |
	        ...
	        |	ПотериОтБракаВыявленный.Продукция1,
	        |	ПотериОтБракаВыявленный.Подразделение1,
	        |	ПотериОтБракаВыявленный.МаркаСтали
	        |ИЗ
	        |	ПотериОтБракаВыявленный КАК ПотериОтБракаВыявленный
	        |;
	        |
	        ...
	        |	БазоваяВыборкаЗнВПОтходы.Раздел,
	        |	БазоваяВыборкаЗнВПОтходы.Группа,
	        |	БазоваяВыборкаЗнВПОтходы.МаркаСтали
	        |ПОМЕСТИТЬ БазоваяВыборкаЗнВПОтходы
	        |ИЗ
	        |	(ВЫБРАТЬ
	        |		БазоваяВыборкаЗнВП.Организация КАК Организация,
	        ...
	        |		NULL КАК Раздел,
	        |		NULL КАК Группа,
	        |		БазоваяВыборкаЗнВП.МаркаСтали КАК МаркаСтали
	        |	ИЗ
	        |		БазоваяВыборкаЗнВП КАК БазоваяВыборкаЗнВП
	        |	ГДЕ
	        |		БазоваяВыборкаЗнВП.СтатьяЗатрат <> &Отходы
	        ...
	        |		NULL,
	        |		NULL,
	        |		РПП_РемонтыСодержаниеОхранаТранспортПрочие.МаркаСтали
	        |	ИЗ
	        |		РПП_РемонтыСодержаниеОхранаТранспортПрочие КАК РПП_РемонтыСодержаниеОхранаТранспортПрочие
	        |	
	        |	ОБЪЕДИНИТЬ ВСЕ
	        ...
	        |	БазоваяВыборкаЗнВПОтходыРазделы.ПокупныеСобственные,
	        |	БазоваяВыборкаЗнВПОтходыРазделы.ЕдиницаИзмерения,
	        |	БазоваяВыборкаЗнВПОтходыРазделы.МаркаСтали
	        |ПОМЕСТИТЬ БазоваяВыборкаЗнВПОтходыРазделыГруппы
	        |ИЗ
	        |	БазоваяВыборкаЗнВПОтходыРазделы КАК БазоваяВыборкаЗнВПОтходыРазделы
	        |;
	        ...
	        |		СУММА(НЗПНаКонец.КоличествоОборот) КАК КоличествоОборот,
	        |		НЗПНаКонец.Раздел КАК Раздел,
	        |		НЗПНаКонец.МаркаСтали КАК МаркаСтали
	        |	ИЗ
	        |		(ВЫБРАТЬ
	        |			ЗатратыНаВыпускПродукцииНаработкаБухгалтерскийУчетОстатки.Организация КАК Организация,
	        |			ЗатратыНаВыпускПродукцииНаработкаБухгалтерскийУчетОстатки.Подразделение КАК Подразделение,
	        ...
	        |								СпособыРаспределения КАК СпособыРаспределения)) КАК ЗатратыНаВыпускПродукцииНаработкаБухгалтерскийУчетОстатки
	        |				ЛЕВОЕ СОЕДИНЕНИЕ МаркиСтали КАК МаркиСтали
	        |				ПО ЗатратыНаВыпускПродукцииНаработкаБухгалтерскийУчетОстатки.ХарактеристикаПродукции = МаркиСтали.Объект
	        |		
	        |		ОБЪЕДИНИТЬ ВСЕ
	        |		
	        |		ВЫБРАТЬ
	        ...
	        |								СпособыРаспределения КАК СпособыРаспределения)) КАК ЗатратыНаВыпускПродукцииНаработкаБухгалтерскийУчетОбороты
	        |				ЛЕВОЕ СОЕДИНЕНИЕ МаркиСтали КАК МаркиСтали
	        |				ПО ЗатратыНаВыпускПродукцииНаработкаБухгалтерскийУчетОбороты.ХарактеристикаПродукции = МаркиСтали.Объект
	        |		
	        |		ОБЪЕДИНИТЬ ВСЕ
	        |		
	        |		ВЫБРАТЬ
	        ...
	        |		НЗПНаКонец.Продукция,
	        |		НЗПНаКонец.Раздел,
	        |		НЗПНаКонец.МаркаСтали) КАК НЗПНаНачало
	        |;
	        |
	        |////////////////////////////////////////////////////////////////////////////////
	        |ВЫБРАТЬ
	        ...
	        |		НЗПНаКонец.Продукция,
	        |		НЗПНаКонец.Раздел,
	        |		НЗПНаКонец.МаркаСтали) КАК НЗПНаКонец
	        |;
	        |
	        |////////////////////////////////////////////////////////////////////////////////
	        |ВЫБРАТЬ
	        ...
	        |		СУММА(ВыпускСУчетомНЗП.КоличествоНЗПНаНачало) КАК КоличествоНЗПНаНачало,
	        |		СУММА(ВыпускСУчетомНЗП.КоличествоНЗПНаКонец) КАК КоличествоНЗПНаКонец,
	        |		ВыпускСУчетомНЗП.МаркаСтали КАК МаркаСтали
	        |	ИЗ
	        |		(ВЫБРАТЬ
	        |			ИтогоВыпуск.Организация КАК Организация,
	        |			ИтогоВыпуск.Подразделение КАК Подразделение,
	        ...
	        |			0 КАК КоличествоНЗПНаНачало,
	        |			0 КАК КоличествоНЗПНаКонец,
	        |			ИтогоВыпуск.МаркаСтали КАК МаркаСтали
	        |		ИЗ
	        |			ИтогоВыпускСНЗП КАК ИтогоВыпуск
	        |		
	        |		ОБЪЕДИНИТЬ ВСЕ
	        ...
	        |		ВыпускСУчетомНЗП.Подразделение,
	        |		ВыпускСУчетомНЗП.Продукция,
	        |		ВыпускСУчетомНЗП.МаркаСтали) КАК ВыпускСУчетомНЗП
	        |;
	        |
	        |////////////////////////////////////////////////////////////////////////////////
	        |ВЫБРАТЬ
	        ...
	        |	БазоваяВыборкаЗнВПОтходыРазделыГруппы.Подразделение,
	        |	БазоваяВыборкаЗнВПОтходыРазделыГруппы.Продукция,
	        |	БазоваяВыборкаЗнВПОтходыРазделыГруппы.МаркаСтали
	        |ПОМЕСТИТЬ Металлошихта
	        |ИЗ
	        |	БазоваяВыборкаЗнВПОтходыРазделыГруппы КАК БазоваяВыборкаЗнВПОтходыРазделыГруппы
	        |ГДЕ
	        ...
	        |			И Металлошихта.Подразделение = ВыпускПродукции.Подразделение
	        |			И Металлошихта.Продукция = ВыпускПродукции.Продукция
	        |			И Металлошихта.МаркаСтали = ВыпускПродукции.МаркаСтали
	        |;
	        |
	        |////////////////////////////////////////////////////////////////////////////////
	        |ВЫБРАТЬ
	        ...
	        |			И МеталлошихтаВыпуск.Подразделение = ОтходыКоличествоВсего.ПодразделениеОрганизации
	        |			И МеталлошихтаВыпуск.Продукция = ОтходыКоличествоВсего.Продукция
	        |			И МеталлошихтаВыпуск.МаркаСтали = ОтходыКоличествоВсего.МаркаСтали
	        |		ВНУТРЕННЕЕ СОЕДИНЕНИЕ БракИтого КАК БракИтого
	        |		ПО МеталлошихтаВыпуск.Организация = БракИтого.Организация
	        |			И МеталлошихтаВыпуск.Подразделение = БракИтого.Подразделение
	        |			И МеталлошихтаВыпуск.Продукция = БракИтого.Продукция
	        |			И МеталлошихтаВыпуск.МаркаСтали = БракИтого.МаркаСтали
	        |;
	        |
	        |////////////////////////////////////////////////////////////////////////////////
	        |ВЫБРАТЬ
	        ...
	        |	СУММА(БазоваяВыборкаЗнВПОтходыРазделыГруппыПодгруппы.КоличествоОборот) КАК КоличествоОборот,
	        |	СУММА(БазоваяВыборкаЗнВПОтходыРазделыГруппыПодгруппы.СуммаОборот) КАК СуммаОборот,
	        |	БазоваяВыборкаЗнВПОтходыРазделыГруппыПодгруппы.МаркаСтали
	        |ПОМЕСТИТЬ ИтогоЗатраты
	        |ИЗ
	        |	БазоваяВыборкаЗнВПОтходыРазделыГруппы КАК БазоваяВыборкаЗнВПОтходыРазделыГруппыПодгруппы
	        |
	        ...
	        |			И СырьеИМатериалы.Подразделение = ИтогоВыпуск.Подразделение
	        |			И СырьеИМатериалы.Продукция = ИтогоВыпуск.Продукция
	        |			И СырьеИМатериалы.МаркаСтали = ИтогоВыпуск.МаркаСтали
	        |		ЛЕВОЕ СОЕДИНЕНИЕ ДобавочныеМатериалы КАК ДобавочныеМатериалы
	        |		ПО СырьеИМатериалы.Организация = ДобавочныеМатериалы.Организация
	        |			И СырьеИМатериалы.Подразделение = ДобавочныеМатериалы.Подразделение
	        |			И СырьеИМатериалы.Продукция = ДобавочныеМатериалы.Продукция
	        |			И СырьеИМатериалы.МаркаСтали = ДобавочныеМатериалы.МаркаСтали
	        |;
	        |
	        |////////////////////////////////////////////////////////////////////////////////
	        |ВЫБРАТЬ
	        ...
	        |		БазоваяВыборкаЗнВПОтходыРазделыГруппыПодгруппы.Продукция КАК Продукция,
	        |		СУММА(БазоваяВыборкаЗнВПОтходыРазделыГруппыПодгруппы.СуммаОборот) КАК СуммаОборот,
	        |		БазоваяВыборкаЗнВПОтходыРазделыГруппыПодгруппы.МаркаСтали КАК МаркаСтали
	        |	ИЗ
	        |		БазоваяВыборкаЗнВПОтходыРазделыГруппы КАК БазоваяВыборкаЗнВПОтходыРазделыГруппыПодгруппы
	        |	ГДЕ
	        |		БазоваяВыборкаЗнВПОтходыРазделыГруппыПодгруппы.Раздел = ""Расходы по переделу""
	        ...
	        |		БазоваяВыборкаЗнВПОтходыРазделыГруппыПодгруппы.Подразделение,
	        |		БазоваяВыборкаЗнВПОтходыРазделыГруппыПодгруппы.Продукция,
	        |		БазоваяВыборкаЗнВПОтходыРазделыГруппыПодгруппы.МаркаСтали) КАК РППИтого
	        |		ВНУТРЕННЕЕ СОЕДИНЕНИЕ ИтогоВыпускКоличество КАК ИтогоВыпуск
	        |		ПО РППИтого.Организация = ИтогоВыпуск.Организация
	        |			И РППИтого.Подразделение = ИтогоВыпуск.Подразделение
	        |			И РППИтого.Продукция = ИтогоВыпуск.Продукция
	        |			И РППИтого.МаркаСтали = ИтогоВыпуск.МаркаСтали
	        |;
	        |
	        |////////////////////////////////////////////////////////////////////////////////
	        |ВЫБРАТЬ
	        ...
	        |	СУММА(ПРоизводственнаяСебестоимость.СуммаОборот) КАК СтоимостьОборот,
	        |	СУММА(ПРоизводственнаяСебестоимость.КоличествоВыпуск) КАК КоличествоОборот,
	        |	ПРоизводственнаяСебестоимость.МаркаСтали
	        |ПОМЕСТИТЬ ПроизводственнаяСебестоимостьСумма
	        |ИЗ
	        |	(ВЫБРАТЬ
	        |		Задано.Организация КАК Организация,
	        ...
	        |		Задано.СтоимостьМеталлошихтаМинусОтходы КАК СуммаОборот,
	        |		Задано.КоличествоВыпуск КАК КоличествоВыпуск,
	        |		Задано.МаркаСтали КАК МаркаСтали
	        |	ИЗ
	        |		Задано КАК Задано
	        |	
	        |	ОБЪЕДИНИТЬ ВСЕ
	        ...
	        |			0 КАК СтоимостьНЗПНаНачало,
	        |			0 КАК СтоимостьНЗПНаКонец,
	        |			ПроизводственнаяСебестоимостьСумма.МаркаСтали КАК МаркаСтали
	        |		ИЗ
	        |			ПроизводственнаяСебестоимостьСумма КАК ПроизводственнаяСебестоимостьСумма
	        |		
	        |		ОБЪЕДИНИТЬ ВСЕ
	        ...
	        |	СУММА(ИтогоВыпускКоличествоИСумма.СтоимостьНЗПНаКонец) КАК СтоимостьНЗПНаКонец,
	        |	СУММА(ИтогоВыпускКоличествоИСумма.СтоимостьСНЗП) КАК СтоимостьСНЗП,
	        |	ИтогоВыпускКоличествоИСумма.МаркаСтали
	        |ПОМЕСТИТЬ ИтогоВыпуск
	        |ИЗ
	        |	(ВЫБРАТЬ
	        |		ИтогоВыпускКоличество.Организация КАК Организация,
	        ...
	        |		0 КАК СтоимостьНЗПНаКонец,
	        |		0 КАК СтоимостьСНЗП,
	        |		ИтогоВыпускКоличество.МаркаСтали КАК МаркаСтали
	        |	ИЗ
	        |		ИтогоВыпускКоличество КАК ИтогоВыпускКоличество
	        |	
	        |	ОБЪЕДИНИТЬ ВСЕ
	        ...
	        |	ЗаданоВсегоСДобавочными.СтоимостьНаЕдиницу,
	        |	ЗаданоВсегоСДобавочными.КоличествоНаЕдиницу,
	        |	ЗаданоВсегоСДобавочными.МаркаСтали
	        |ИЗ
	        |	ЗаданоВсегоСДобавочными КАК ЗаданоВсегоСДобавочными
	        |;
	        |
	        ...
	        |	РезультатБезПорядка.СуммаОборот / Задано.КоличествоВыпуск КАК СтоимостьНаЕдиницу,
	        |	РезультатБезПорядка.КоличествоОборот / Задано.КоличествоВыпуск КАК КоличествоНаЕдиницу,
	        |	РезультатБезПорядка.МаркаСтали
	        |ПОМЕСТИТЬ Результат
	        |ИЗ
	        |	РезультатБезПорядка КАК РезультатБезПорядка
	        |		ЛЕВОЕ СОЕДИНЕНИЕ Задано КАК Задано
	        ...
	        |			И РезультатБезПорядка.Подразделение = Задано.Подразделение
	        |			И РезультатБезПорядка.Продукция = Задано.Продукция
	        |			И РезультатБезПорядка.МаркаСтали = Задано.МаркаСтали
	        |;
	        |
	        |////////////////////////////////////////////////////////////////////////////////
	        |ВЫБРАТЬ
	        ...
	        |	КОНЕЦ КАК СтоимостьНаЕдиницу,
	        |	""Производственная себестоимость с НЗП"" КАК Раздел,
	        |	ИтогоВыпуск.МаркаСтали
	        |ИЗ
	        |	ИтогоВыпуск КАК ИтогоВыпуск
	        |ГДЕ
	        |	ИтогоВыпуск.Продукция = &Продукция
	        |	И ИтогоВыпуск.МаркаСтали = &МаркаСтали
	        |;
	        |
	        |////////////////////////////////////////////////////////////////////////////////
	        |ВЫБРАТЬ
	        ...
	        |			И НЗПНаНачало.Подразделение = ИтогоВыпуск.Подразделение
	        |			И НЗПНаНачало.Продукция = ИтогоВыпуск.Продукция
	        |			И НЗПНаНачало.МаркаСтали = ИтогоВыпуск.МаркаСтали
	        |ГДЕ
	        |	НЗПНаНачало.Продукция = &Продукция
	        |	И НЗПНаНачало.МаркаСтали = &МаркаСтали
	        |;
	        |
	        |////////////////////////////////////////////////////////////////////////////////
	        |ВЫБРАТЬ
	        ...
	        |			И НЗПНаКонец.Подразделение = ИтогоВыпуск.Подразделение
	        |			И НЗПНаКонец.Продукция = ИтогоВыпуск.Продукция
	        |			И НЗПНаКонец.МаркаСтали = ИтогоВыпуск.МаркаСтали
	        |ГДЕ
	        |	НЗПНаКонец.Продукция = &Продукция
	        |	И НЗПНаКонец.МаркаСтали = &МаркаСтали
	        |;
	        |
	        |////////////////////////////////////////////////////////////////////////////////
	        |ВЫБРАТЬ
	        ...
	        |	БазоваяВыборкаЗнВПРасшифровка.ПокупныеСобственные,
	        |	БазоваяВыборкаЗнВПРасшифровка.ЕдиницаИзмерения,
	        |	БазоваяВыборкаЗнВПРасшифровка.МаркаСтали
	        |ИЗ
	        |	БазоваяВыборкаЗнВПРасшифровка КАК БазоваяВыборкаЗнВПРасшифровка
	        |;
	        |
	        ...
	        |	СУММА(Результат.СтоимостьНаЕдиницу) КАК СтоимостьНаЕдиницу,
	        |	СУММА(0) КАК КоличествоНаЕдиницу,
	        |	Результат.МаркаСтали
	        |ИЗ
	        |	Результат КАК Результат
	        |ГДЕ
	        |	Результат.Продукция = &Продукция
	        |	И Результат.МаркаСтали = &МаркаСтали
	        |
	        |СГРУППИРОВАТЬ ПО
	        |	Результат.Организация,
	        |	Результат.Подразделение,
